...
public class ArraysAndStreams2 {
    public static void main(String[] args) {
        ...
        // find and display strings that start with a vowel and ignoring case
        ...
        // combine all the strings and then display it
        System.out.printf("concatenated string: %s%n",
                Arrays.stream(strings)
                        .collect(Collectors.joining(", "))
        );

        // count how many strings have more than five characters and display the number
